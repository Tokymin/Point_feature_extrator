...
class L2_Net(PatchNet):
    ...
    def __init__(self, dim=128, **kw):
        ...
        add_conv(64, k=1, stride=1)
        add_conv(64)
        # add_conv(128, stride=2)
        add_conv(128, k=1, stride=1)
        add_conv(128)
