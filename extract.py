...
def extract_keypoints(args):
    ...
    while args.images:
        ...
        img = Image.open(r"F:\Toky\Dataset\Endo_colon_unity\test_for_point_feature\photo4/" + img_path).convert('RGB')
        W, H = img.size
        ...
        outpath = r"F:\Toky\Dataset\Endo_colon_unity\test_for_point_feature\photo4\\" + img_path + '.' + args.tag
